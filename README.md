...
<img src="img/one.jpg" height="500"/>
  ...
  <div id="two">
    ...
    <p>El Chevrolet Celebrity poseía tracción en las ruedas delanteras, un atractivo diseño y motores de baja cilindrada que favorecían el consumo de combustible.<br><br>
      ...
      Este modelo llegó a venderse con muy buenos resultados en mercados emergentes como México y Colombia donde en este último, a pesar de la invasión de autos coreanos,chinos y japoneses sigue vigente por su mecánica fiable y en algunos casos fácil de reparar.</p>
  </div>
...
<h3 id="h3">Modelos y diferencias:</h3>
  ...
  <a href="https://www.youtube.com/watch?v=3eLTpnUXKXg" style="color:rgb(167, 132, 126);" id="six" target="_blank" rel="noopener noreferrer">Celebrity en Venezuela (Publicidad 1.984)</a>
  ...
  <div id="four">
    <h6 id="h6">Motorizaciones:</h6>
    <p>Motorizaciones disponibles entre 1982 - 1991​:</p><br><br>
     <ul>
      <li>4L - 151 plgs³ - 2.5 L - 90 hp (67 kW) (1982-1988)</li><br><br>
      <li>4L - 151 plgs³ - 2.5 L - 102 hp (76 kW) (1989)</li><br><br>
      <li>V6 - 173 plgs³ - 2.8 L - 135 hp (101 kW) (1986-1989)</li><br><br>
      <li>V6 - 191 plgs³ - 3.1 L - 145 hp (108 kW) (1990)</li><br><br>
      <li>V6 diésel - 263 plgs³ - 4.3 L - 85 hp (63 kW) (1982-1985)</li><br><br>
    </ul>
      <br><br> <p>El Chevrolet Celebrity tuvo gran éxito en ventas en los Estados Unidos, llegando a ser el coche más vendido en todo el país en 1986, todo debido a sus características estéticas, mecánicas y de manejo, muy al gusto de los consumidores americanos.
      <br><br> Comparado con su antecesor, el Malibú Classic, era económico en combustible (en especial al recibir el V6 con MPFI), más espacioso y más seguro por su tracción delantera.
      <br><br> También hubo una versión de máximo lujo, llamada «Black Tie» (Corbata Negra), exclusiva de Estados Unidos.
      <img src="img/celeb5.jpg" height="500"/><br>
      <br><br> En 1988 el modelo de dos puertas se descontinúa por bajas ventas.
      
      <br><br>La producción del Celebrity cesa el 7 de julio de 1989 después de comercializar unas unidades modelo 1990 Station Wagon.
      <br><br> El nuevo Chevrolet Lumina sustituye en el mercado norteamericano al Celebrity 2 y 4 puertas. La Station Wagon fue sustituida por la nueva minivan Chevrolet Lumina APV.</p>
  </div>
  <div id="five">
  <footer>         
    <p><u>Agradecimientos:</u></p>
    <p>YouTube</p>   
    <p>Wikipedia</p>  
    <br><br>
    <a href="mailto:salasfjulioe@gmail.com" style="color: rgb(8, 84, 226);" >Me puedes contactar aqui.</a>
    <p>Copyright 2022</p>
</footer>  </div>
</body>
</html>
